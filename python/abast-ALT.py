...
axs[0,0].plot(ALT['hora'], ALT['ImpoN']+ALT['EolicoN']+ALT['FosilN']+ALT['HidroN']+ALT['SolarN'], color='darkviolet', linewidth = 2)
...
axs[0,1].plot(ALT['hora'], ALT['ImpoC']+ALT['EolicoC']+ALT['FosilC']+ALT['HidroC']+ALT['SolarC'], color='darkviolet', linewidth = 2)
...
axs[0,2].plot(ALT['hora'], ALT['ImpoO']+ALT['EolicoO']+ALT['FosilO']+ALT['HidroO']+ALT['SolarO'], color='darkviolet', linewidth = 2)
...
axs[0,3].plot(ALT['hora'], ALT['ImpoS']+ALT['EolicoS']+ALT['FosilS']+ALT['HidroS']+ALT['SolarS'], color='darkviolet', linewidth = 2)
