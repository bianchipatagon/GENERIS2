...
ax1.legend(["Hydro","Wind","Solar"], frameon=False,bbox_to_anchor=(0.9, 0.9), borderaxespad=0.,fontsize=11)
...
fig.text(0.04, 0.5, '[MW]', va='center' ,fontsize=15, rotation='vertical')  
