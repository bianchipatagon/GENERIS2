...
ax1.bar(ad['Anio'], ad['HidroT'], color='#0000CD')
ax1.bar(ad['Anio'], ad['EolicaT'], bottom=ad['HidroT'], color='#8FC73E')
ax1.bar(ad['Anio'], ad['Solar'], bottom=ad['HidroT']+ad['EolicaT'], color='#FBAA1B')
ax1.legend(["Solar","Wind","Hydro"], frameon=False,bbox_to_anchor=(0.9, 0.9), borderaxespad=0.,fontsize=12)
ax1.set_xlim(2023, 2050)
# ~ ax1.set_ylabel('[MW]', fontsize=12)

ax2 = fig.add_subplot(gs[0, 1])
ax2.set_title('ALT', fontsize = 13)
ax2.bar(ad['Anio'], ad['Hidro'], color='#0000CD')
ax2.bar(ad['Anio'], ad['Eolica'], bottom=ad['Hidro'], color='#8FC73E')
ax2.bar(ad['Anio'], ad['Hidro'], bottom=ad['Hidro']+ad['Eolica'], color='#FBAA1B')
