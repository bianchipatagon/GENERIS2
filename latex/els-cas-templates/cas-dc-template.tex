...
Para el corte temporal de 2030, se observa que los flujos de potencia entre regiones difieren según la temporada y el momento del día. Durante la temporada seca, las regiones de Oriente y Sur son las principales exportadoras (figura 16) en la franja horaria desde las 00hs hasta las 18hs.  Las exportaciones están dirigidas a la región Norte (figura 17). Para las horas de la tarde y noche, la exportación se realiza desde la región Oriente hacia la región Sur. Durante la estación húmeda, la exportación se realiza desde las regiones Oriente y Centro hacia la región Sur, salvo durante la franja horaria de producción solar en la que se produce exportación desde la región Sur, con una importante generación solar (figura 18), a la región Norte. La región Centro nuevamente actúa como vínculo entre las regiones que no se conectan entre sí. Cabe destacar que, en este escenario la región Oriente cuenta con importantes adiciones de potencia eólica e hidroeléctrica (figura 5)
