...
\begin{table}[!ht]
	...
	\begin{tabular}{lcc}
		\toprule
		\textbf{Technology} & 	\textbf{Capital} & \textbf{O\&M} \\
	
		\textbf{} & \textbf{[USD/MW]} & \textbf{[USD/MW-yr]} \\
		\midrule
		TG & 855 & 8 \\
		TV & 1,800 & 20 \\
		Diesel & 1,200 & 15 \\
...
\begin{figure*}[tp]
	%\includegraphics[clip,width=1\columnwidth]{mapas3.png}
	\includegraphics[width=0.8\textwidth]{generacion.png}
	\caption{\label{gene} Current (2023) and projected annual electricity generation according to BAU, BAU-SD, ALT and ALT-SD scenarios}
\end{figure*}

The addition of SD capacity produces positive externalities in terms of fuel savings and GHG emissions. An additional 900 MW of SD capacity produces greater fuel savings for the BAU scenario than for the ALT scenario. Fuel savings for the BAU-SD scenario reach 960 kBEP annually by 2050 compared to BAU, with accumulated savings of 15,000 kBEP over the simulation period — nearly the total inputs for power generation in the base year. For the ALT-SD scenario, by contrast, accumulated savings total only 1,930 kBEP compared to ALT. GHG emissions follow a similar pattern: accumulated emission savings are greater for the BAU-SD scenario compared to BAU (9,900,000 metric tonnes of CO\textsubscript{2}-equivalent, Figure \ref{emis}) than for the ALT-SD scenario compared to ALT (1,170,000 metric tonnes of CO\textsubscript{2}-equivalent).

\begin{figure}[hbpt]
	\includegraphics[clip,width=1\columnwidth]{emis.png}
	\caption{\label{emis} Annual GHG emmisions according to BAU, BAU-SD, ALT and ALT-SD scenarios}
\end{figure}
...
\begin{table}[!ht]
	...
	%\resizebox{0.8\columnwidth}{!}{%
		\begin{tabular}{lcccc}
			\toprule
			\textbf{} & \textbf{BAU} & 	\textbf{(BAU-SD)} & \textbf{ALT} & \textbf{(ALT-SD)} \\
			\textbf{} & \textbf{}  & \textbf{-BAU} & \textbf{} & \textbf{-ALT} \\
...
\subsubsection{Regional power generation and trade scenarios}

\begin{figure*}[tp]
	%\includegraphics[clip,width=1\columnwidth]{mapas3.png}
	\includegraphics[width=\textwidth]{tradeTEN.png}
	\caption{\label{impo} Current (2023) and projected annual electricity generation according to BAU, BAU-SD, ALT and ALT-SD scenarios}
\end{figure*}

\begin{figure*}[tp]
	%\includegraphics[clip,width=1\columnwidth]{mapas3.png}
	\includegraphics[width=\textwidth]{inputTEN.jpg}
	\caption{\label{inputTEN} Current (2023) and projected annual electricity generation according to BAU, BAU-SD, ALT and ALT-SD scenarios}
\end{figure*}
