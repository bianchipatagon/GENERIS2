...
All these centralized capacity additions are configured in LEAP as exogenous capacity additions. Table XX shows... INCLUIR FACTORES DE CAPACIDAD Y AVAILABILITY CURVES . A minimum reserve margin of 30\% was assigned for the NIS, and differential NG production costs across regions were configured to represent the regional availability of this resource. NEMO optimization allows for endogenous capacity expansion when needed to meet the reserve margin requirement. NEMO optimization assigned a total endogenous capacity of 160 MW of turbo-gas (TG) units for the BAU scenario during the simulation period, whereas no endogenous capacity expansions were observed for the ALT scenario.
...
\begin{figure}[hbpt]
	\includegraphics[clip,width=1.1\columnwidth]{scenarios.png}
	\caption{\label{scenarios} Regional centralized capacity additions according to BAU and ALT scenarios}
\end{figure}

Se realizó un análisis de la evolución de las fuentes de energía primaria y secundaria de la matriz de generación eléctrica de cada región. Se analizó también el flujo de potencia a nivel horario en las líneas eléctricas que conectan las diferentes regiones para los años de corte 2030, 2040 y 2050. Para el año 2050, además, se realizó un balance a nivel horario por región considerando producción de energía eléctrica por fuente y exportación/importación a través de las líneas eléctricas. 
 
\begin{figure*}[tp]
	%\includegraphics[clip,width=1\columnwidth]{mapas3.png}
	\includegraphics[width=\textwidth]{impoTEN.jpg}
	\caption{\label{mapa3} Current (2023) annual electricity demand (a); thermal (b), hydro (c) and wind/solar (d) installed capacity}
\end{figure*}
